...
CREATE TABLE SOLICITACAO_AMIZADE (
	...
	ID_SOLICITADO   NUMBER(12) NOT NULL,
		...
		CONSTRAINT FK_SOLICITACAO_AMIZADE_ID_SOLICITANTE FOREIGN KEY (ID_SOLICITANTE) REFERENCES USUARIO (ID),
		CONSTRAINT FK_SOLCIITACAO_AMIZADE_ID_SOLICITADO FOREIGN KEY (ID_SOLICITADO) REFERENCES USUARIO (ID)
);
